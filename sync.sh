...
while true; do  
  rsync -azr --exclude "*.swp" --exclude 'main' --exclude '/newData' --exclude 'dataExtraction' --exclude '__pycache__' --exclude 'people/' --exclude 'output' --exclude 'saved_models' src/ hzwr87@ncc.clients.dur.ac.uk:~/reidSource --delete
